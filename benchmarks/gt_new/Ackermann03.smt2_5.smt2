...
(assert
 ...
 (let (($x452 (and (=> (and (= (ControlFlow 1 230314) 230315) (and (= SIV_24 1) (= (ControlFlow 1 230315) 230313)) (and (= SIV_27 true) (= (ControlFlow 1 230313) 230306)) (= SIV_28 0) (and (= SIV_29 SIV_27) (= (ControlFlow 1 230306) 235537)) (= (ControlFlow 1 235537) (- 0 236016))) $x303) (=> (and (= (ControlFlow 1 230314) 230316) $x429) $x436))))
 (let (($x445 (and (not (= SIV_23 1)) (= SIV_24 (ite (not (= $u0 2)) 1 0)))))
 ...
 (let (($x468 (and (=> (and (= (ControlFlow 1 230311) 230312) (and (= SIV_23 1) (= (ControlFlow 1 230312) 230313)) (and (= SIV_27 true) (= (ControlFlow 1 230313) 230306)) (= SIV_28 0) (and (= SIV_29 SIV_27) (= (ControlFlow 1 230306) 235537)) (= (ControlFlow 1 235537) (- 0 236016))) $x303) (=> (and (= (ControlFlow 1 230311) 230314) $x445) $x452))))
 (let (($x460 (and (boogie_si_record_i32 SIV_22) (= SIV_23 (ite (not (= $u0 2)) 1 0)))))
 (let (($x461 (and (and (not (= SIV_21 1)) (= SIV_22 (ackermann_cb $u0 $u0))) $x460)))
 ...
 (let (($x482 (and (=> (and (= (ControlFlow 1 230309) 230310) (and (= SIV_21 1) (= (ControlFlow 1 230310) 230308)) (and (= SIV_27 true) (= (ControlFlow 1 230308) 230306)) (= SIV_28 0) (and (= SIV_29 SIV_27) (= (ControlFlow 1 230306) 235537)) (= (ControlFlow 1 235537) (- 0 236016))) $x303) (=> (and (= (ControlFlow 1 230309) 230311) $x461) $x468))))
 (let (($x475 (and (not (= SIV_20 1)) (= SIV_21 (ite (> $u0 23) 1 0)))))
 ...
 (let (($x495 (and (=> (and (= (ControlFlow 1 230305) 230307) (and (= SIV_20 1) (= (ControlFlow 1 230307) 230308)) (and (= SIV_27 true) (= (ControlFlow 1 230308) 230306)) (= SIV_28 0) (and (= SIV_29 SIV_27) (= (ControlFlow 1 230306) 235537)) (= (ControlFlow 1 235537) (- 0 236016))) $x303) (=> (and (= (ControlFlow 1 230305) 230309) $x475) $x482))))
 (let (($x488 (and (not (= SIV_19 1)) (= SIV_20 (ite (< $u0 0) 1 0)))))
 ...
 (let (($x509 (and (=> (and (= (ControlFlow 1 230303) 230304) (and (= SIV_19 1) (= (ControlFlow 1 230304) 230302)) (and (= SIV_27 true) (= (ControlFlow 1 230302) 230306)) (= SIV_28 0) (and (= SIV_29 SIV_27) (= (ControlFlow 1 230306) 235537)) (= (ControlFlow 1 235537) (- 0 236016))) $x303) (=> (and (= (ControlFlow 1 230303) 230305) $x488) $x495))))
 (let (($x502 (and (not (= SIV_18 1)) (= SIV_19 (ite (> $u0 3) 1 0)))))
 ...
 (let (($x523 (and (=> (and (= (ControlFlow 1 230300) 230301) (and (= SIV_18 1) (= (ControlFlow 1 230301) 230302)) (and (= SIV_27 true) (= (ControlFlow 1 230302) 230306)) (= SIV_28 0) (and (= SIV_29 SIV_27) (= (ControlFlow 1 230306) 235537)) (= (ControlFlow 1 235537) (- 0 236016))) $x303) (=> (and (= (ControlFlow 1 230300) 230303) $x502) $x509))))
 (let (($x515 (and (boogie_si_record_ref main_) (= SIV_18 (ite (< $u0 0) 1 0)))))
 (let (($x529 (=> (and (= (ControlFlow 1 235535) 230300) true (and (and true SIV_30) $x515)) $x523)))
 (let (($x535 (and (= (ControlFlow 1 0) 235542) (not (=> (and (and true (= (ControlFlow 1 235542) 235535)) (= (ControlFlow 1 235535) 230300) true (and (and true SIV_30) $x515)) $x523)))))
 (=> SIV_5 $x535))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x660 (and (and true true) (and SIV_35 (= (ControlFlow 2 230823) (- 0 236131))))))
 (let (($x667 (=> (and (= (ControlFlow 2 236096) 230823) true (and true SIV_34) $x660) false)))
 (let (($x673 (and (= (ControlFlow 2 0) 236098) (not (=> (and (and true (= (ControlFlow 2 236098) 236096)) (= (ControlFlow 2 236096) 230823) true (and true SIV_34) $x660) false)))))
 (=> SIV_30 $x673)))))
(assert
 (let (($x684 (not SIV_40)))
 (let (($x685 (= SIV_26 $x684)))
 (let (($x686 (=> (= (ControlFlow 3 236161) (- 0 236246)) $x685)))
 (let (($x711 (=> (and (and (= SIV_40 SIV_39) (= (ControlFlow 3 230466) 236161)) (= (ControlFlow 3 236161) (- 0 236246))) $x685)))
 (let (($x718 (=> (and (and (= SIV_39 true) (= (ControlFlow 3 230465) 230466)) (and (= SIV_40 SIV_39) (= (ControlFlow 3 230466) 236161)) (= (ControlFlow 3 236161) (- 0 236246))) $x685)))
 (let (($x726 (=> (and (= (ControlFlow 3 230460) 230465) (not (= 0 $0)) (and (= SIV_39 true) (= (ControlFlow 3 230465) 230466)) (and (= SIV_40 SIV_39) (= (ControlFlow 3 230466) 236161)) (= (ControlFlow 3 236161) (- 0 236246))) $x685)))
 (let (($x693 (=> (and (and (= SIV_40 false) (= (ControlFlow 3 230462) 236161)) (= (ControlFlow 3 236161) (- 0 236246))) $x685)))
 (let (($x703 (and (=> (and (= (ControlFlow 3 230461) 230462) (not false) (and (= SIV_40 false) (= (ControlFlow 3 230462) 236161)) (= (ControlFlow 3 236161) (- 0 236246))) $x685) (=> (= (ControlFlow 3 230461) 230463) true))))
 (let (($x695 (= 0 $0)))
 ...
 (=> SIV_31 (and (= (ControlFlow 3 0) 236166) (not $x736)))))))))))))))
(check-sat)
