...
(assert
 ...
 (let (($x225 (and (= SIV@13 (ite (not (= SIV@12 25)) 1 0)) (= (ControlFlow 1 281544) 281545))))
 (let (($x226 (and (and (= SIV@12 (id_cb 25)) (boogie_si_record_i32 SIV@12)) $x225)))
...
(assert
 ...
 (=> SIV@19 $x323))))
(assert
 (let (($x338 (=> (and (= (ControlFlow 5 306519) 281328) (= (ControlFlow 5 281328) (- 0 306550))) false)))
 (let (($x344 (and (= (ControlFlow 5 0) 306521) (not (=> (and (and true (= (ControlFlow 5 306521) 306519)) (= (ControlFlow 5 306519) 281328) (= (ControlFlow 5 281328) (- 0 306550))) false)))))
 (=> SIV@20 $x344))))
(check-sat)
