...
(assert
 ...
 (let (($x231 (=> (and (and (not (= SIV@20 1)) (= SIV@21 (addition@@0 $u0 $u0))) $x229 (and (not (= SIV@23 1)) (= (ControlFlow 1 285137) 285138)) (and $x193 (and SIV@26 (= (ControlFlow 1 285138) 285139))) (and (not SIV@24) (= (ControlFlow 1 285139) (- 0 310378)))) (not (and (= SIV@4 SIV@27) (= SIV@3 SIV@24))))))
 ...
 (let (($x256 (=> (and (not (= SIV@18 1)) $x254 (not (= SIV@19 1)) $x242 (and (not (= SIV@20 1)) (= SIV@21 (addition@@0 $u0 $u0))) $x229 (and (not (= SIV@23 1)) (= (ControlFlow 1 285137) 285138)) (and $x193 (and SIV@26 (= (ControlFlow 1 285138) 285139))) (and (not SIV@24) (= (ControlFlow 1 285139) (- 0 310378)))) (not (and (= SIV@4 SIV@27) (= SIV@3 SIV@24))))))
 ...
 (let (($x276 (=> (and (and (and SIV@25 (boogie_si_record_ref main)) $x274) (not (= SIV@17 1)) $x264 (not (= SIV@18 1)) $x254 (not (= SIV@19 1)) $x242 (and (not (= SIV@20 1)) (= SIV@21 (addition@@0 $u0 $u0))) $x229 (and (not (= SIV@23 1)) (= (ControlFlow 1 285137) 285138)) (and $x193 (and SIV@26 (= (ControlFlow 1 285138) 285139))) (and (not SIV@24) (= (ControlFlow 1 285139) (- 0 310378)))) (not (and (= SIV@4 SIV@27) (= SIV@3 SIV@24))))))
 (let (($x285 (=> (and (and true (= (ControlFlow 1 309973) 309970)) (= (ControlFlow 1 309970) 285132) $x193 (and (and SIV@25 (boogie_si_record_ref main)) $x274) (not (= SIV@17 1)) $x264 (not (= SIV@18 1)) $x254 (not (= SIV@19 1)) $x242 (and (not (= SIV@20 1)) (= SIV@21 (addition@@0 $u0 $u0))) $x229 (and (not (= SIV@23 1)) (= (ControlFlow 1 285137) 285138)) (and $x193 (and SIV@26 (= (ControlFlow 1 285138) 285139))) (and (not SIV@24) (= (ControlFlow 1 285139) (- 0 310378)))) (not (and (= SIV@4 SIV@27) (= SIV@3 SIV@24))))))
