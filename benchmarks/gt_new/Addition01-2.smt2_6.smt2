...
(assert
 (let (($x598 (and (and true true) (and SIV_33 (= (ControlFlow 2 229916) (- 0 235048))))))
 (let (($x605 (=> (and (= (ControlFlow 2 235013) 229916) true (and true SIV_32) $x598) false)))
 (let (($x611 (and (= (ControlFlow 2 0) 235015) (not (=> (and (and true (= (ControlFlow 2 235015) 235013)) (= (ControlFlow 2 235013) 229916) true (and true SIV_32) $x598) false)))))
 (=> SIV_28 $x611)))))
(assert
 (let (($x623 (not SIV_38)))
 (let (($x624 (= SIV_24 $x623)))
 (let (($x625 (=> (= (ControlFlow 3 235078) (- 0 235163)) $x624)))
 (let (($x650 (=> (and (and (= SIV_38 SIV_37) (= (ControlFlow 3 229559) 235078)) (= (ControlFlow 3 235078) (- 0 235163))) $x624)))
 (let (($x657 (=> (and (and (= SIV_37 true) (= (ControlFlow 3 229558) 229559)) (and (= SIV_38 SIV_37) (= (ControlFlow 3 229559) 235078)) (= (ControlFlow 3 235078) (- 0 235163))) $x624)))
 (let (($x665 (=> (and (= (ControlFlow 3 229553) 229558) (not (= 0 $0)) (and (= SIV_37 true) (= (ControlFlow 3 229558) 229559)) (and (= SIV_38 SIV_37) (= (ControlFlow 3 229559) 235078)) (= (ControlFlow 3 235078) (- 0 235163))) $x624)))
 (let (($x632 (=> (and (and (= SIV_38 false) (= (ControlFlow 3 229555) 235078)) (= (ControlFlow 3 235078) (- 0 235163))) $x624)))
 (let (($x642 (and (=> (and (= (ControlFlow 3 229554) 229555) (not false) (and (= SIV_38 false) (= (ControlFlow 3 229555) 235078)) (= (ControlFlow 3 235078) (- 0 235163))) $x624) (=> (= (ControlFlow 3 229554) 229556) true))))
 (let (($x634 (= 0 $0)))
 ...
 (=> SIV_29 (and (= (ControlFlow 3 0) 235083) (not $x675)))))))))))))))
(assert
