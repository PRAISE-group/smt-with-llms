...
(declare-fun SIV_87 () Bool)
(declare-fun SIV_85 () Int)
(declare-fun SIV_84 () Int)
(declare-fun SIV_83 () Int)
(declare-fun SIV_82 () Int)
(assert
...
(assert
 ...
 (let (($x617 (and (and (boogie_si_record_i32 1) (boogie_si_record_i32 3)) (and $x612 (= SIV_41 (ite (= $u0 0) 1 0))))))
...
(assert
 ...
 (let (($x405 (and true true)))
 (let (($x852 (and (and $x405 (and SIV_70 (= SIV_69 (- SIV_44 1)))) (and $x405 (and SIV_71 (= (ControlFlow 7 230504) 230505))))))
 (let (($x841 (and (and (not (= SIV_65 1)) (= SIV_67 (+ SIV_66 1))) (and (boogie_si_record_i32 SIV_67) (= SIV_68 (- SIV_44 1))))))
 (let (($x858 (=> (and (and (= SIV_65 1) (= (ControlFlow 7 230503) 230505)) (= (ControlFlow 7 230505) (- 0 237052))) false)))
 (let (($x871 (and (=> (and (= (ControlFlow 7 230502) 230503) (and (= SIV_65 1) (= (ControlFlow 7 230503) 230505)) (= (ControlFlow 7 230505) (- 0 237052))) false) (=> (and (= (ControlFlow 7 230502) 230504) $x841 $x852 (= (ControlFlow 7 230505) (- 0 237052))) false))))
 (let (($x610 (boogie_si_record_i32 3)))
 (let (($x865 (and (and (boogie_si_record_i32 1) (boogie_si_record_i32 2)) (and $x610 (= SIV_65 (ite (= SIV_44 0) 1 0))))))
 (let (($x876 (=> (and (= (ControlFlow 7 236693) 230502) (boogie_si_record_i32 SIV_44) $x865) $x871)))
 (let (($x882 (and (= (ControlFlow 7 0) 236699) (not (=> (and (and true (= (ControlFlow 7 236699) 236693)) (= (ControlFlow 7 236693) 230502) (boogie_si_record_i32 SIV_44) $x865) $x871)))))
 (=> SIV_46 $x882))))))))))))
(assert
 (let (($x889 (=> (= (ControlFlow 8 230505) (- 0 237052)) false)))
 (let (($x405 (and true true)))
 (let (($x914 (and (and $x405 (and SIV_87 (= SIV_86 (- SIV_45 1)))) (and $x405 (and SIV_88 (= (ControlFlow 8 230504) 230505))))))
 (let (($x903 (and (and (not (= SIV_82 1)) (= SIV_84 (+ SIV_83 1))) (and (boogie_si_record_i32 SIV_84) (= SIV_85 (- SIV_45 1))))))
 (let (($x920 (=> (and (and (= SIV_82 1) (= (ControlFlow 8 230503) 230505)) (= (ControlFlow 8 230505) (- 0 237052))) false)))
 (let (($x933 (and (=> (and (= (ControlFlow 8 230502) 230503) (and (= SIV_82 1) (= (ControlFlow 8 230503) 230505)) (= (ControlFlow 8 230505) (- 0 237052))) false) (=> (and (= (ControlFlow 8 230502) 230504) $x903 $x914 (= (ControlFlow 8 230505) (- 0 237052))) false))))
 (let (($x609 (boogie_si_record_i32 1)))
 (let (($x927 (and (and (boogie_si_record_i32 2) (boogie_si_record_i32 3)) (and $x609 (= SIV_82 (ite (= SIV_45 0) 1 0))))))
 (let (($x938 (=> (and (= (ControlFlow 8 236693) 230502) (boogie_si_record_i32 SIV_45) $x927) $x933)))
 (let (($x944 (and (= (ControlFlow 8 0) 236699) (not (=> (and (and true (= (ControlFlow 8 236699) 236693)) (= (ControlFlow 8 236693) 230502) (boogie_si_record_i32 SIV_45) $x927) $x933)))))
 (=> SIV_47 $x944))))))))))))
(assert
 (not SIV_88))
(assert
