...
(assert  (=> SIV@183 (and (= (ControlFlow 12 0) 242617) (not (let (($bb3_correct@@0  (=> (= (ControlFlow 12 234822) (- 0 243002)) (not (= SIV@180 SIV@207)))))
(let (($bb7_correct@@0  (=> (and (and (and (not (= SIV@203 1)) (= SIV@204 (- SIV@179 1))) (and true true)) (and (and SIV@208 (= SIV@206 (+ $u0 SIV@205))) (and (= SIV@207 SIV@206) (= (ControlFlow 12 234826) 234822)))) $bb3_correct@@0)))
(let (($bb6_correct@@0  (=> (= SIV@203 1) (=> (and (= SIV@207 1) (= (ControlFlow 12 234825) 234822)) $bb3_correct@@0))))
(let (($bb5_correct@@0  (=> (and (not (= SIV@202 1)) (= SIV@203 (ite (= SIV@179 1) 1 0))) (and (=> (= (ControlFlow 12 234824) 234825) $bb6_correct@@0) (=> (= (ControlFlow 12 234824) 234826) $bb7_correct@@0)))))
(let (($bb4_correct@@0  (=> (= SIV@202 1) (=> (and (= SIV@207 0) (= (ControlFlow 12 234823) 234822)) $bb3_correct@@0))))
(let (($bb2_correct@@0  (=> (and (not (= SIV@199 1)) (= SIV@202 (ite (= SIV@179 0) 1 0))) (and (=> (= (ControlFlow 12 234821) 234823) $bb4_correct@@0) (=> (= (ControlFlow 12 234821) 234824) $bb5_correct@@0)))))
(let (($bb1_correct@@0  (=> (= SIV@199 1) (=> (and (= SIV@200 (- 0 SIV@179)) true) (=> (and (and true SIV@209) (and (= SIV@207 SIV@201) (= (ControlFlow 12 234820) 234822))) $bb3_correct@@0)))))
(let (($bb0_correct@@1  (=> (boogie_si_record_i32 $u0) (=> (and (boogie_si_record_i32 SIV@179) (= SIV@199 (ite (< SIV@179 0) 1 0))) (and (=> (= (ControlFlow 12 234819) 234820) $bb1_correct@@0) (=> (= (ControlFlow 12 234819) 234821) $bb2_correct@@0))))))
(let ((q@0_correct@@3  (=> (= (ControlFlow 12 242612) 234819) $bb0_correct@@1)))
(let ((PreconditionGeneratedEntry_correct@@3  (=> (and true (= (ControlFlow 12 242617) 242612)) q@0_correct@@3)))
PreconditionGeneratedEntry_correct@@3))))))))))))))
(push 1)
(assert (not
SIV@134
...
(pop 1)
; Inlining mult from mult
(declare-fun SIV@232 () Int)
(declare-fun SIV@228 () Int)
(declare-fun SIV@229 () Int)
(declare-fun SIV@233 () Bool)
(declare-fun SIV@231 () Int)
(declare-fun SIV@230 () Int)
(declare-fun SIV@227 () Int)
(declare-fun SIV@224 () Int)
(declare-fun SIV@225 () Int)
(declare-fun SIV@234 () Bool)
(declare-fun SIV@226 () Int)
(assert  (=> SIV@208 (and (= (ControlFlow 13 0) 242617) (not (let (($bb3_correct@@0  (=> (= (ControlFlow 13 234822) (- 0 243002)) (not (= SIV@205 SIV@232)))))
(let (($bb7_correct@@0  (=> (and (and (and (not (= SIV@228 1)) (= SIV@229 (- SIV@204 1))) (and true true)) (and (and SIV@233 (= SIV@231 (+ $u0 SIV@230))) (and (= SIV@232 SIV@231) (= (ControlFlow 13 234826) 234822)))) $bb3_correct@@0)))
(let (($bb6_correct@@0  (=> (= SIV@228 1) (=> (and (= SIV@232 1) (= (ControlFlow 13 234825) 234822)) $bb3_correct@@0))))
(let (($bb5_correct@@0  (=> (and (not (= SIV@227 1)) (= SIV@228 (ite (= SIV@204 1) 1 0))) (and (=> (= (ControlFlow 13 234824) 234825) $bb6_correct@@0) (=> (= (ControlFlow 13 234824) 234826) $bb7_correct@@0)))))
(let (($bb4_correct@@0  (=> (= SIV@227 1) (=> (and (= SIV@232 0) (= (ControlFlow 13 234823) 234822)) $bb3_correct@@0))))
(let (($bb2_correct@@0  (=> (and (not (= SIV@224 1)) (= SIV@227 (ite (= SIV@204 0) 1 0))) (and (=> (= (ControlFlow 13 234821) 234823) $bb4_correct@@0) (=> (= (ControlFlow 13 234821) 234824) $bb5_correct@@0)))))
(let (($bb1_correct@@0  (=> (= SIV@224 1) (=> (and (= SIV@225 (- 0 SIV@204)) true) (=> (and (and true SIV@234) (and (= SIV@232 SIV@226) (= (ControlFlow 13 234820) 234822))) $bb3_correct@@0)))))
(let (($bb0_correct@@1  (=> (boogie_si_record_i32 $u0) (=> (and (boogie_si_record_i32 SIV@204) (= SIV@224 (ite (< SIV@204 0) 1 0))) (and (=> (= (ControlFlow 13 234819) 234820) $bb1_correct@@0) (=> (= (ControlFlow 13 234819) 234821) $bb2_correct@@0))))))
(let ((q@0_correct@@3  (=> (= (ControlFlow 13 242612) 234819) $bb0_correct@@1)))
(let ((PreconditionGeneratedEntry_correct@@3  (=> (and true (= (ControlFlow 13 242617) 242612)) q@0_correct@@3)))
PreconditionGeneratedEntry_correct@@3))))))))))))))
(push 1)
(assert (not
SIV@134
...
(pop 1)
; Inlining mult from mult
(declare-fun SIV@257 () Int)
(declare-fun SIV@253 () Int)
(declare-fun SIV@254 () Int)
(declare-fun SIV@258 () Bool)
(declare-fun SIV@256 () Int)
(declare-fun SIV@255 () Int)
(declare-fun SIV@252 () Int)
(declare-fun SIV@249 () Int)
(declare-fun SIV@250 () Int)
(declare-fun SIV@259 () Bool)
(declare-fun SIV@251 () Int)
(assert  (=> SIV@233 (and (= (ControlFlow 14 0) 242617) (not (let (($bb3_correct@@0  (=> (= (ControlFlow 14 234822) (- 0 243002)) (not (= SIV@230 SIV@257)))))
(let (($bb7_correct@@0  (=> (and (and (and (not (= SIV@253 1)) (= SIV@254 (- SIV@229 1))) (and true true)) (and (and SIV@258 (= SIV@256 (+ $u0 SIV@255))) (and (= SIV@257 SIV@256) (= (ControlFlow 14 234826) 234822)))) $bb3_correct@@0)))
(let (($bb6_correct@@0  (=> (= SIV@253 1) (=> (and (= SIV@257 1) (= (ControlFlow 14 234825) 234822)) $bb3_correct@@0))))
(let (($bb5_correct@@0  (=> (and (not (= SIV@252 1)) (= SIV@253 (ite (= SIV@229 1) 1 0))) (and (=> (= (ControlFlow 14 234824) 234825) $bb6_correct@@0) (=> (= (ControlFlow 14 234824) 234826) $bb7_correct@@0)))))
(let (($bb4_correct@@0  (=> (= SIV@252 1) (=> (and (= SIV@257 0) (= (ControlFlow 14 234823) 234822)) $bb3_correct@@0))))
(let (($bb2_correct@@0  (=> (and (not (= SIV@249 1)) (= SIV@252 (ite (= SIV@229 0) 1 0))) (and (=> (= (ControlFlow 14 234821) 234823) $bb4_correct@@0) (=> (= (ControlFlow 14 234821) 234824) $bb5_correct@@0)))))
(let (($bb1_correct@@0  (=> (= SIV@249 1) (=> (and (= SIV@250 (- 0 SIV@229)) true) (=> (and (and true SIV@259) (and (= SIV@257 SIV@251) (= (ControlFlow 14 234820) 234822))) $bb3_correct@@0)))))
(let (($bb0_correct@@1  (=> (boogie_si_record_i32 $u0) (=> (and (boogie_si_record_i32 SIV@229) (= SIV@249 (ite (< SIV@229 0) 1 0))) (and (=> (= (ControlFlow 14 234819) 234820) $bb1_correct@@0) (=> (= (ControlFlow 14 234819) 234821) $bb2_correct@@0))))))
(let ((q@0_correct@@3  (=> (= (ControlFlow 14 242612) 234819) $bb0_correct@@1)))
(let ((PreconditionGeneratedEntry_correct@@3  (=> (and true (= (ControlFlow 14 242617) 242612)) q@0_correct@@3)))
PreconditionGeneratedEntry_correct@@3))))))))))))))
(push 1)
(assert (not
SIV@134
...
(pop 1)
; Inlining mult from mult
(declare-fun SIV@282 () Int)
(declare-fun SIV@278 () Int)
(declare-fun SIV@279 () Int)
(declare-fun SIV@283 () Bool)
(declare-fun SIV@281 () Int)
(declare-fun SIV@280 () Int)
(declare-fun SIV@277 () Int)
(declare-fun SIV@274 () Int)
(declare-fun SIV@275 () Int)
(declare-fun SIV@284 () Bool)
(declare-fun SIV@276 () Int)
(assert  (=> SIV@258 (and (= (ControlFlow 15 0) 242617) (not (let (($bb3_correct@@0  (=> (= (ControlFlow 15 234822) (- 0 243002)) (not (= SIV@255 SIV@282)))))
(let (($bb7_correct@@0  (=> (and (and (and (not (= SIV@278 1)) (= SIV@279 (- SIV@254 1))) (and true true)) (and (and SIV@283 (= SIV@281 (+ $u0 SIV@280))) (and (= SIV@282 SIV@281) (= (ControlFlow 15 234826) 234822)))) $bb3_correct@@0)))
(let (($bb6_correct@@0  (=> (= SIV@278 1) (=> (and (= SIV@282 1) (= (ControlFlow 15 234825) 234822)) $bb3_correct@@0))))
(let (($bb5_correct@@0  (=> (and (not (= SIV@277 1)) (= SIV@278 (ite (= SIV@254 1) 1 0))) (and (=> (= (ControlFlow 15 234824) 234825) $bb6_correct@@0) (=> (= (ControlFlow 15 234824) 234826) $bb7_correct@@0)))))
(let (($bb4_correct@@0  (=> (= SIV@277 1) (=> (and (= SIV@282 0) (= (ControlFlow 15 234823) 234822)) $bb3_correct@@0))))
(let (($bb2_correct@@0  (=> (and (not (= SIV@274 1)) (= SIV@277 (ite (= SIV@254 0) 1 0))) (and (=> (= (ControlFlow 15 234821) 234823) $bb4_correct@@0) (=> (= (ControlFlow 15 234821) 234824) $bb5_correct@@0)))))
(let (($bb1_correct@@0  (=> (= SIV@274 1) (=> (and (= SIV@275 (- 0 SIV@254)) true) (=> (and (and true SIV@284) (and (= SIV@282 SIV@276) (= (ControlFlow 15 234820) 234822))) $bb3_correct@@0)))))
(let (($bb0_correct@@1  (=> (boogie_si_record_i32 $u0) (=> (and (boogie_si_record_i32 SIV@254) (= SIV@274 (ite (< SIV@254 0) 1 0))) (and (=> (= (ControlFlow 15 234819) 234820) $bb1_correct@@0) (=> (= (ControlFlow 15 234819) 234821) $bb2_correct@@0))))))
(let ((q@0_correct@@3  (=> (= (ControlFlow 15 242612) 234819) $bb0_correct@@1)))
(let ((PreconditionGeneratedEntry_correct@@3  (=> (and true (= (ControlFlow 15 242617) 242612)) q@0_correct@@3)))
PreconditionGeneratedEntry_correct@@3))))))))))))))
(push 1)
(assert (not
SIV@134
