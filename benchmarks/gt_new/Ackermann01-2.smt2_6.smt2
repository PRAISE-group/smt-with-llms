...
(assert
 ...
 (let (($x458 (and (and (not (= SIV@21 1)) (= SIV@22 (ackermann_cb $u0 $u0))) $x457)))
 ...
 (=> SIV@5 $x530))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x655 (and (and true true) (and SIV@35 (= (ControlFlow 2 230823) (- 0 236131))))))
 (let (($x662 (=> (and (= (ControlFlow 2 236096) 230823) true (and true SIV@34) $x655) false)))
 (let (($x668 (and (= (ControlFlow 2 0) 236098) (not (=> (and (and true (= (ControlFlow 2 236098) 236096)) (= (ControlFlow 2 236096) 230823) true (and true SIV@34) $x655) false)))))
 (=> SIV@30 $x668)))))
(assert
 (let (($x679 (not SIV@40)))
 (let (($x680 (= SIV@26 $x679)))
 (let (($x681 (=> (= (ControlFlow 3 236161) (- 0 236246)) $x680)))
 (let (($x706 (=> (and (and (= SIV@40 SIV@39) (= (ControlFlow 3 230466) 236161)) (= (ControlFlow 3 236161) (- 0 236246))) $x680)))
 (let (($x713 (=> (and (and (= SIV@39 true) (= (ControlFlow 3 230465) 230466)) (and (= SIV@40 SIV@39) (= (ControlFlow 3 230466) 236161)) (= (ControlFlow 3 236161) (- 0 236246))) $x680)))
 (let (($x721 (=> (and (= (ControlFlow 3 230460) 230465) (not (= 0 $0)) (and (= SIV@39 true) (= (ControlFlow 3 230465) 230466)) (and (= SIV@40 SIV@39) (= (ControlFlow 3 230466) 236161)) (= (ControlFlow 3 236161) (- 0 236246))) $x680)))
 (let (($x688 (=> (and (and (= SIV@40 false) (= (ControlFlow 3 230462) 236161)) (= (ControlFlow 3 236161) (- 0 236246))) $x680)))
 (let (($x698 (and (=> (and (= (ControlFlow 3 230461) 230462) (not false) (and (= SIV@40 false) (= (ControlFlow 3 230462) 236161)) (= (ControlFlow 3 236161) (- 0 236246))) $x680) (=> (= (ControlFlow 3 230461) 230463) true))))
 (let (($x690 (= 0 $0)))
 ...
 (=> SIV@31 (and (= (ControlFlow 3 0) 236166) (not $x731)))))))))))))))
(assert
