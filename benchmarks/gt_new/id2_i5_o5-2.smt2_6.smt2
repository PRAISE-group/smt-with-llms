...
(assert
 ...
 (let (($x380 (and (boogie_si_record_i32 SIV@12) (= SIV@13 (ite (not (= SIV@12 5)) 1 0)))))
 (let (($x381 (and (and (boogie_si_record_ref main) (= SIV@12 (id_cb 5))) $x380)))
...
(assert
 (let (($x589 (=> (and (= (ControlFlow 4 232327) 227533) (= (ControlFlow 4 227533) (- 0 232334))) false)))
 (let (($x595 (and (= (ControlFlow 4 0) 232329) (not (=> (and (and true (= (ControlFlow 4 232329) 232327)) (= (ControlFlow 4 232327) 227533) (= (ControlFlow 4 227533) (- 0 232334))) false)))))
 (=> SIV@22 $x595))))
(assert
 (let (($x609 (=> (and (= (ControlFlow 5 232342) 227497) (= (ControlFlow 5 227497) (- 0 232361))) false)))
 (let (($x615 (and (= (ControlFlow 5 0) 232344) (not (=> (and (and true (= (ControlFlow 5 232344) 232342)) (= (ControlFlow 5 232342) 227497) (= (ControlFlow 5 227497) (- 0 232361))) false)))))
 (=> SIV@23 $x615))))
(check-sat)
