...
(let (($bb0__unique__1_correct  (=> (and (and (and true true) (and SIV@15 (boogie_si_record_ref main))) (and (and (= SIV@12 (id@@0 25)) (boogie_si_record_i32 SIV@12)) (and (= SIV@13 (ite (not (= SIV@12 25)) 1 0)) (= (ControlFlow 1 281544) 281545)))) $bb1__unique__2_correct)))
