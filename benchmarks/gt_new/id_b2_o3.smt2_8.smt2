...
(assert
 ...
 (let (($x411 (and (and (boogie_si_record_i32 SIV@13) (= SIV@14 (id_cb SIV@13))) $x410)))
...
(assert
 ...
 (=> SIV@26 $x686))))
(assert
 (let (($x705 (not (= SIV@30 SIV@54))))
 (let (($x391 (and true true)))
 (let (($x702 (and $x391 (and SIV@67 (= (ControlFlow 7 232023) (- 0 238448))))))
 (let (($x707 (=> (and (= SIV@65 SIV@64) $x702) $x705)))
 (let (($x716 (=> (and (and (= SIV@64 0) (= (ControlFlow 7 232022) 232023)) (= SIV@65 SIV@64) $x702) $x705)))
 (let (($x746 (=> (and (= (ControlFlow 7 232018) 232022) (not (= SIV@62 1)) (and (= SIV@64 0) (= (ControlFlow 7 232022) 232023)) (= SIV@65 SIV@64) $x702) $x705)))
 (let (($x709 (= SIV@62 1)))
 (let (($x729 (and (and $x709 (= SIV@63 (ite (<= SIV@54 SIV@56) 1 0))) (and (= SIV@64 SIV@63) (= (ControlFlow 7 232021) 232023)))))
 (let (($x740 (and $x391 (and SIV@66 (= SIV@62 (ite (>= SIV@54 SIV@55) 1 0))))))
 (let (($x748 (=> $x740 (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV@65 SIV@64) $x702) $x705) $x746))))
 (let (($x749 (=> (and (= SIV@61 SIV@60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV@65 SIV@64) $x702) $x705) $x746))))
 (let (($x792 (=> (and (and (= SIV@60 0) (= (ControlFlow 7 232017) 232018)) (= SIV@61 SIV@60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV@65 SIV@64) $x702) $x705) $x746))))
 (let (($x809 (=> (and (= (ControlFlow 7 232015) 232017) (not (= SIV@57 1)) (and (= SIV@60 0) (= (ControlFlow 7 232017) 232018)) (= SIV@61 SIV@60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV@65 SIV@64) $x702) $x705) $x746))))
 (let (($x758 (=> (and (and (= SIV@60 0) (= (ControlFlow 7 232020) 232018)) (= SIV@61 SIV@60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV@65 SIV@64) $x702) $x705) $x746))))
 (let (($x784 (=> (and (= (ControlFlow 7 232016) 232020) (not (= SIV@58 1)) (and (= SIV@60 0) (= (ControlFlow 7 232020) 232018)) (= SIV@61 SIV@60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV@65 SIV@64) $x702) $x705) $x746))))
 (let (($x751 (= SIV@58 1)))
 (let (($x771 (and (and $x751 (= SIV@59 (ite (<= SIV@56 4294967295) 1 0))) (and (= SIV@60 SIV@59) (= (ControlFlow 7 232019) 232018)))))
 (let (($x774 (= SIV@57 1)))
 (let (($x786 (=> (and $x774 (= SIV@58 (ite (>= SIV@56 4294967295) 1 0))) (and (=> (and (= (ControlFlow 7 232016) 232019) $x771 (= SIV@61 SIV@60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV@65 SIV@64) $x702) $x705) $x746)) $x784))))
 (let (($x797 (boogie_si_record_i32 SIV@56)))
 (let (($x803 (and (and (boogie_si_record_i32 SIV@55) $x797) (and $x797 (= SIV@57 (ite (= SIV@55 0) 1 0))))))
 (let (($x812 (=> (and (and (boogie_si_record_i32 SIV@54) (boogie_si_record_i32 SIV@55)) $x803) (and (=> (and (= (ControlFlow 7 232015) 232016) (and $x774 (= SIV@58 (ite (>= SIV@56 4294967295) 1 0)))) (and (=> (and (= (ControlFlow 7 232016) 232019) $x771 (= SIV@61 SIV@60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV@65 SIV@64) $x702) $x705) $x746)) $x784)) $x809))))
 (let (($x794 (boogie_si_record_i32 SIV@54)))
 (let (($x821 (=> (and (and true (= (ControlFlow 7 237971) 237968)) (= (ControlFlow 7 237968) 232015) $x794 (and $x794 (boogie_si_record_i32 SIV@55)) $x803) (and (=> (and (= (ControlFlow 7 232015) 232016) (and $x774 (= SIV@58 (ite (>= SIV@56 4294967295) 1 0)))) (and (=> (and (= (ControlFlow 7 232016) 232019) $x771 (= SIV@61 SIV@60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV@65 SIV@64) $x702) $x705) $x746)) $x784)) $x809))))
 (=> SIV@31 (and (= (ControlFlow 7 0) 237971) (not $x821))))))))))))))))))))))))))))
(assert
 (let (($x916 (and (not (= SIV@61 $0)) (= (ControlFlow 8 231290) (- 0 238574)))))
 (let (($x922 (=> (and (= (ControlFlow 8 238525) 231290) (boogie_si_record_i32 SIV@61) $x916) false)))
 (let (($x928 (and (= (ControlFlow 8 0) 238528) (not (=> (and (and true (= (ControlFlow 8 238528) 238525)) (= (ControlFlow 8 238525) 231290) (boogie_si_record_i32 SIV@61) $x916) false)))))
 (=> SIV@66 $x928)))))
(assert
 (let (($x938 (and (not (= SIV@65 $0)) (= (ControlFlow 9 231290) (- 0 238574)))))
 (let (($x943 (=> (and (= (ControlFlow 9 238525) 231290) (boogie_si_record_i32 SIV@65) $x938) false)))
 (let (($x949 (and (= (ControlFlow 9 0) 238528) (not (=> (and (and true (= (ControlFlow 9 238528) 238525)) (= (ControlFlow 9 238525) 231290) (boogie_si_record_i32 SIV@65) $x938) false)))))
 (=> SIV@67 $x949)))))
(check-sat)
