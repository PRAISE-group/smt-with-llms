...
(assert
 ...
 (let (($x411 (and (and (boogie_si_record_i32 SIV_13) (= SIV_14 (id_cb SIV_13))) $x410)))
...
(assert
 (let (($x659 (=> (and (= (ControlFlow 5 237920) 232244) (= (ControlFlow 5 232244) (- 0 237927))) false)))
 (let (($x665 (and (= (ControlFlow 5 0) 237922) (not (=> (and (and true (= (ControlFlow 5 237922) 237920)) (= (ControlFlow 5 237920) 232244) (= (ControlFlow 5 232244) (- 0 237927))) false)))))
 (=> SIV_25 $x665))))
(assert
 (let (($x680 (=> (and (= (ControlFlow 6 237935) 232208) (= (ControlFlow 6 232208) (- 0 237954))) false)))
 (let (($x686 (and (= (ControlFlow 6 0) 237937) (not (=> (and (and true (= (ControlFlow 6 237937) 237935)) (= (ControlFlow 6 237935) 232208) (= (ControlFlow 6 232208) (- 0 237954))) false)))))
 (=> SIV_26 $x686))))
(assert
 (let (($x705 (not (= SIV_30 SIV_54))))
 (let (($x391 (and true true)))
 (let (($x702 (and $x391 (and SIV_67 (= (ControlFlow 7 232023) (- 0 238448))))))
 (let (($x707 (=> (and (= SIV_65 SIV_64) $x702) $x705)))
 (let (($x716 (=> (and (and (= SIV_64 0) (= (ControlFlow 7 232022) 232023)) (= SIV_65 SIV_64) $x702) $x705)))
 (let (($x746 (=> (and (= (ControlFlow 7 232018) 232022) (not (= SIV_62 1)) (and (= SIV_64 0) (= (ControlFlow 7 232022) 232023)) (= SIV_65 SIV_64) $x702) $x705)))
 (let (($x709 (= SIV_62 1)))
 (let (($x729 (and (and $x709 (= SIV_63 (ite (<= SIV_54 SIV_56) 1 0))) (and (= SIV_64 SIV_63) (= (ControlFlow 7 232021) 232023)))))
 (let (($x740 (and $x391 (and SIV_66 (= SIV_62 (ite (>= SIV_54 SIV_55) 1 0))))))
 (let (($x748 (=> $x740 (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV_65 SIV_64) $x702) $x705) $x746))))
 (let (($x749 (=> (and (= SIV_61 SIV_60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV_65 SIV_64) $x702) $x705) $x746))))
 (let (($x792 (=> (and (and (= SIV_60 0) (= (ControlFlow 7 232017) 232018)) (= SIV_61 SIV_60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV_65 SIV_64) $x702) $x705) $x746))))
 (let (($x809 (=> (and (= (ControlFlow 7 232015) 232017) (not (= SIV_57 1)) (and (= SIV_60 0) (= (ControlFlow 7 232017) 232018)) (= SIV_61 SIV_60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV_65 SIV_64) $x702) $x705) $x746))))
 (let (($x758 (=> (and (and (= SIV_60 0) (= (ControlFlow 7 232020) 232018)) (= SIV_61 SIV_60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV_65 SIV_64) $x702) $x705) $x746))))
 (let (($x784 (=> (and (= (ControlFlow 7 232016) 232020) (not (= SIV_58 1)) (and (= SIV_60 0) (= (ControlFlow 7 232020) 232018)) (= SIV_61 SIV_60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV_65 SIV_64) $x702) $x705) $x746))))
 (let (($x751 (= SIV_58 1)))
 (let (($x771 (and (and $x751 (= SIV_59 (ite (<= SIV_56 4294967295) 1 0))) (and (= SIV_60 SIV_59) (= (ControlFlow 7 232019) 232018)))))
 (let (($x774 (= SIV_57 1)))
 (let (($x786 (=> (and $x774 (= SIV_58 (ite (>= SIV_56 4294967295) 1 0))) (and (=> (and (= (ControlFlow 7 232016) 232019) $x771 (= SIV_61 SIV_60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV_65 SIV_64) $x702) $x705) $x746)) $x784))))
 (let (($x797 (boogie_si_record_i32 SIV_56)))
 (let (($x803 (and (and (boogie_si_record_i32 SIV_55) $x797) (and $x797 (= SIV_57 (ite (= SIV_55 0) 1 0))))))
 (let (($x812 (=> (and (and (boogie_si_record_i32 SIV_54) (boogie_si_record_i32 SIV_55)) $x803) (and (=> (and (= (ControlFlow 7 232015) 232016) (and $x774 (= SIV_58 (ite (>= SIV_56 4294967295) 1 0)))) (and (=> (and (= (ControlFlow 7 232016) 232019) $x771 (= SIV_61 SIV_60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV_65 SIV_64) $x702) $x705) $x746)) $x784)) $x809))))
 (let (($x794 (boogie_si_record_i32 SIV_54)))
 (let (($x821 (=> (and (and true (= (ControlFlow 7 237971) 237968)) (= (ControlFlow 7 237968) 232015) $x794 (and $x794 (boogie_si_record_i32 SIV_55)) $x803) (and (=> (and (= (ControlFlow 7 232015) 232016) (and $x774 (= SIV_58 (ite (>= SIV_56 4294967295) 1 0)))) (and (=> (and (= (ControlFlow 7 232016) 232019) $x771 (= SIV_61 SIV_60) $x740) (and (=> (and (= (ControlFlow 7 232018) 232021) $x729 (= SIV_65 SIV_64) $x702) $x705) $x746)) $x784)) $x809))))
 (=> SIV_31 (and (= (ControlFlow 7 0) 237971) (not $x821))))))))))))))))))))))))))))
(assert
 (let (($x916 (and (not (= SIV_61 $0)) (= (ControlFlow 8 231290) (- 0 238574)))))
 (let (($x922 (=> (and (= (ControlFlow 8 238525) 231290) (boogie_si_record_i32 SIV_61) $x916) false)))
 (let (($x928 (and (= (ControlFlow 8 0) 238528) (not (=> (and (and true (= (ControlFlow 8 238528) 238525)) (= (ControlFlow 8 238525) 231290) (boogie_si_record_i32 SIV_61) $x916) false)))))
 (=> SIV_66 $x928)))))
(assert
 (let (($x938 (and (not (= SIV_65 $0)) (= (ControlFlow 9 231290) (- 0 238574)))))
 (let (($x943 (=> (and (= (ControlFlow 9 238525) 231290) (boogie_si_record_i32 SIV_65) $x938) false)))
 (let (($x949 (and (= (ControlFlow 9 0) 238528) (not (=> (and (and true (= (ControlFlow 9 238528) 238525)) (= (ControlFlow 9 238525) 231290) (boogie_si_record_i32 SIV_65) $x938) false)))))
 (=> SIV_67 $x949)))))
(check-sat)
