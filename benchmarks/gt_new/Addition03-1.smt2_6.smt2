...
(assert
 ...
 (let (($x430 (and (and (= SIV@17 $u0) (= SIV@18 (addition_cb SIV@16 SIV@17))) $x429)))
...
(assert
 (let (($x660 (=> (and (= (ControlFlow 4 234046) 228944) (= (ControlFlow 4 228944) (- 0 234053))) false)))
 (let (($x666 (and (= (ControlFlow 4 0) 234048) (not (=> (and (and true (= (ControlFlow 4 234048) 234046)) (= (ControlFlow 4 234046) 228944) (= (ControlFlow 4 228944) (- 0 234053))) false)))))
 (=> SIV@30 $x666))))
(assert
 (let (($x681 (=> (and (= (ControlFlow 5 234061) 228908) (= (ControlFlow 5 228908) (- 0 234080))) false)))
 (let (($x687 (and (= (ControlFlow 5 0) 234063) (not (=> (and (and true (= (ControlFlow 5 234063) 234061)) (= (ControlFlow 5 234061) 228908) (= (ControlFlow 5 228908) (- 0 234080))) false)))))
 (=> SIV@31 $x687))))
(check-sat)
