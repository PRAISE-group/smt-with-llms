...
(assert
 (let (($x391 (and true true)))
 (let (($x500 (and $x391 (and SIV_31 (= (ControlFlow 2 232725) (- 0 238273))))))
 (let (($x507 (=> (and (= (ControlFlow 2 238238) 232725) true (and true SIV_30) $x500) false)))
 (let (($x513 (and (= (ControlFlow 2 0) 238240) (not (=> (and (and true (= (ControlFlow 2 238240) 238238)) (= (ControlFlow 2 238238) 232725) true (and true SIV_30) $x500) false)))))
 (=> SIV_24 $x513))))))
(assert
 (let (($x521 (boogie_si_record_i32 SIV_35)))
 (let (($x529 (and (and SIV_36 $x521) (and $x521 (= (ControlFlow 3 232553) (- 0 238390))))))
 (let (($x391 (and true true)))
 (let (($x537 (=> (and (= (ControlFlow 3 238301) 232553) $x391 $x529) (not (= SIV_15 SIV_35)))))
 (let (($x543 (and (= (ControlFlow 3 0) 238304) (not (=> (and (and true (= (ControlFlow 3 238304) 238301)) (= (ControlFlow 3 238301) 232553) $x391 $x529) (not (= SIV_15 SIV_35)))))))
 (=> SIV_25 $x543)))))))
(assert
 (let (($x550 (boogie_si_record_i32 SIV_41)))
 (let (($x555 (and (and SIV_42 $x550) (and $x550 (= (ControlFlow 4 232553) (- 0 238390))))))
 (let (($x391 (and true true)))
 (let (($x562 (=> (and (= (ControlFlow 4 238301) 232553) $x391 $x555) (not (= SIV_16 SIV_41)))))
 (let (($x568 (and (= (ControlFlow 4 0) 238304) (not (=> (and (and true (= (ControlFlow 4 238304) 238301)) (= (ControlFlow 4 238301) 232553) $x391 $x555) (not (= SIV_16 SIV_41)))))))
 (=> SIV_26 $x568)))))))
(assert
 (let (($x580 (not SIV_48)))
 (let (($x581 (= SIV_20 $x580)))
 (let (($x582 (=> (= (ControlFlow 5 238436) (- 0 238521)) $x581)))
 (let (($x607 (=> (and (and (= SIV_48 SIV_47) (= (ControlFlow 5 231844) 238436)) (= (ControlFlow 5 238436) (- 0 238521))) $x581)))
 (let (($x614 (=> (and (and (= SIV_47 true) (= (ControlFlow 5 231843) 231844)) (and (= SIV_48 SIV_47) (= (ControlFlow 5 231844) 238436)) (= (ControlFlow 5 238436) (- 0 238521))) $x581)))
 (let (($x622 (=> (and (= (ControlFlow 5 231838) 231843) (not (= 0 $0)) (and (= SIV_47 true) (= (ControlFlow 5 231843) 231844)) (and (= SIV_48 SIV_47) (= (ControlFlow 5 231844) 238436)) (= (ControlFlow 5 238436) (- 0 238521))) $x581)))
 (let (($x589 (=> (and (and (= SIV_48 false) (= (ControlFlow 5 231840) 238436)) (= (ControlFlow 5 238436) (- 0 238521))) $x581)))
 (let (($x599 (and (=> (and (= (ControlFlow 5 231839) 231840) (not false) (and (= SIV_48 false) (= (ControlFlow 5 231840) 238436)) (= (ControlFlow 5 238436) (- 0 238521))) $x581) (=> (= (ControlFlow 5 231839) 231841) true))))
 (let (($x591 (= 0 $0)))
 ...
 (=> SIV_27 (and (= (ControlFlow 5 0) 238441) (not $x632)))))))))))))))
(check-sat)
