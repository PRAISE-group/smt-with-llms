...
(assert  (and (= (ControlFlow 0 0) 235722) (not (let ((start_correct  (=> (and (and true SIV@5) (and (not SIV@3) (= (ControlFlow 0 231106) (- 0 235776)))) (not (and (= SIV@1 SIV@4) (= SIV@2 SIV@3))))))
(let ((q@0_correct  (=> (= (ControlFlow 0 235719) 231106) start_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (and SIV@0 (= (ControlFlow 0 235722) 235719)) q@0_correct)))
