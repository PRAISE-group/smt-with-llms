...
(assert
 ...
 (let (($x420 (and (and (and (not (= SIV@16 1)) (boogie_si_record_i32 0)) $x405) (and (and SIV@25 (= SIV@17 (hanoi_cb $u0))) $x418))))
...
(assert
 ...
 (let (($x616 (and (boogie_si_record_i32 2) (= SIV@41 (ite (= $u0 0) 1 0)))))
