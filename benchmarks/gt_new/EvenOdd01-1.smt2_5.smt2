...
(assert
 ...
 (let (($x434 (=> (and (and (not (= SIV@15 1)) (= SIV@16 (isOdd_cb $u0))) (and (and (boogie_si_record_i32 SIV@16) (= SIV@17 ?x417)) $x424)) $x432)))
