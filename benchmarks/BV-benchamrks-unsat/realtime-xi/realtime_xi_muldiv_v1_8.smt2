...
(declare-fun in_natural_bv32_cb ((_ BitVec 8)) (_ BitVec 8))
(declare-fun get_hword_cb ((_ BitVec 8)) (_ BitVec 8))
(declare-fun get_lword_cb ((_ BitVec 8)) (_ BitVec 8))
(declare-fun bvshl_int_cb ((_ BitVec 8) (_ BitVec 8)) (_ BitVec 8))
(declare-fun bvlshr_int_cb ((_ BitVec 8) (_ BitVec 8)) (_ BitVec 8))

(declare-const v_initial (_ BitVec 8))
(assert (bvule v_initial (bvshl_int_cb (_ bv1 8) (_ bv15 8))))
(declare-const m_initial (_ BitVec 8))
(assert (= (_ bv1 8) (in_natural_bv32_cb m_initial)))
(declare-const d_initial (_ BitVec 8))
(assert (= (_ bv1 8) (in_natural_bv32_cb d_initial)))
...
(assert (= result_hi__1  (bvshl_int_cb result_hi__0 (_ bv8 8))))

(declare-const result_lo__0 (_ BitVec 8))
(assert (= result_lo__0  (bvsub (bvadd (bvadd v_lo__2 (bvshl_int_cb remainder__0 (_ bv8 8)))
                 (bvlshr_int_cb d_initial (_ bv1 8))) d_initial)))
