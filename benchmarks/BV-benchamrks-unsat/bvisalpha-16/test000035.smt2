...
(assert (= isalpha_ret_3 (isalpha1_cb buffer_12_15)))
(assert (= isalpha_ret_4 (isalpha1_cb buffer_16_19)))
(assert (= isalpha_ret_5 (isalpha1_cb buffer_20_23)))
(assert (= isalpha_ret_6 (isalpha1_cb buffer_23_26)))
