...
(declare-fun retval_5 () (_ BitVec 64) )

(assert (= retval (foo_cb ndx)))
(assert (= retval_1 (foo_cb (bvadd ndx (_ bv1 64)))))
(assert (= retval_2 (foo_cb (bvadd ndx (_ bv2 64)))))
(assert (= retval_3 (foo_cb (bvadd ndx (_ bv3 64)))))
(assert (= retval_4 (foo_cb (bvadd ndx (_ bv4 64)))))
(assert (= retval_5 (foo_cb (bvadd ndx (_ bv5 64)))))
...
(=  true (=  (_ bv0 64)  retval_3 ) ) )
(bvule  (bvadd  (_ bv4 64)  ndx ) (_ bv32767 64)  ) )
(=  true (=  (_ bv0 64)  retval_4 ) ) )
(bvule  (bvadd  (_ bv5 64)  ndx ) (_ bv32767 64)  ) )
(=  true (=  (_ bv0 64)  retval_5 ) ) )
(bvule  (bvadd  (_ bv6 64)  ndx ) (_ bv32767 64)  ) ) )
