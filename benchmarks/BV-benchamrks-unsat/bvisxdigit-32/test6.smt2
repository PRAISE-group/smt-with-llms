...
(assert (= retval_5 (foo_cb (bvadd ndx (_ bv5 32)))))


(assert

(and  (and  (and  (and  (and  (and  (and  (and  (and  (and  (and  (and
(bvule  ndx (_ bv255 32)  )
(=  false (= (_ bv0 32)  retval ) ) )
(bvule  (bvadd  (_ bv1 32)  ndx ) (_ bv255 32)  ) )
(=  true (= (_ bv0 32)  retval_1 ) ) )
(bvule  (bvadd  (_ bv2 32)  ndx ) (_ bv255 32)  ) )
(=  true (=  (_ bv0 32)  retval_2 ) ) )
(bvule  (bvadd  (_ bv3 32)  ndx ) (_ bv255 32)  ) )
(=  true (=  (_ bv0 32)  retval_3 ) ) )
(bvule  (bvadd  (_ bv4 32)  ndx ) (_ bv255 32)  ) )
(=  true (=  (_ bv0 32)  retval_4 ) ) )
(bvule  (bvadd  (_ bv5 32)  ndx ) (_ bv255 32)  ) )
(=  true (=  (_ bv0 32)  retval_5 ) ) )
(bvule  (bvadd  (_ bv6 32)  ndx ) (_ bv255 32)  ) ) )
