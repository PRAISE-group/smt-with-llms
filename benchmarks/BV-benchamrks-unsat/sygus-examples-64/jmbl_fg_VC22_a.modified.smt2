...
(declare-fun f_jmbl_fg_VC22_a_cb ((_ BitVec 32) (_ BitVec 32)) (_ BitVec 32))
...
(declare-fun InV1_cb ((_ BitVec 32) (_ BitVec 32) (_ BitVec 32)) (_ BitVec 32))

(declare-fun InV2_cb ((_ BitVec 32) (_ BitVec 32) (_ BitVec 32) (_ BitVec 32)) (_ BitVec 32))
...
(assert ( InVorZero (f_jmbl_fg_VC22_a_cb x1 x2)))

(assert (and (or (= (_ bv1 32) (InV2_cb v1 v2 V_min V_mux_))
	    	(Zero (f_jmbl_fg_VC22_a_cb x1 x2)))
	    (and
		(Unsafe x1 x2 (f_jmbl_fg_VC22_a_cb x1 x2) (f_jmbl_fg_VC22_a_cb x1 x2))
		(not (Zero (f_jmbl_fg_VC22_a_cb (bvadd x1 (f_jmbl_fg_VC22_a_cb x1 x2)) (bvadd x2 (f_jmbl_fg_VC22_a_cb x1 x2))))))))

(assert (and (or
		(not (= (_ bv1 32) (InV2_cb v1 v2 V_min V_mux_)))
		     (or (Unsafe x1 x2 v1 v2)
		     	 (Zero (f_jmbl_fg_VC22_a_cb (bvadd x1 v1) (bvadd x2 v2)) ) ))

	    (not (Zero (f_jmbl_fg_VC22_a_cb x1 x2)))))

(assert (or (Mad_ x1 x2) (not (Zero (f_jmbl_fg_VC22_a_cb x1 x2)))))
