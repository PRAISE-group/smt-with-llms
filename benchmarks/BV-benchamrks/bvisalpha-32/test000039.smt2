...
(declare-fun buffer_10 () (_ BitVec 32) )
...
(declare-fun isalpha_ret_10 () (_ BitVec 32) )
...
(assert (= isalpha_ret_10 (isalpha_cb buffer_10)))
...
(=  false (=  (_ bv0 32) buffer_10 ) )
(=  false (= (_ bv0 32) isalpha_ret_10 ) ) )
