...
(declare-fun _lt ((_ BitVec 32) (_ BitVec 32)) (_ BitVec 32))
(declare-fun _mul ((_ BitVec 32) (_ BitVec 32)) (_ BitVec 32))

(assert (not (= f1 f2)))
(assert (= (_ bv0 32) (_lt (bvadd (_mul (_ bv4 32) f3) (_ bv1 32)) (_ bv2 32))))

(assert (let ((?v_0 (bvadd (_mul (_ bv4 32) f3) (_ bv1 32))))
	(let ((?v_1 (_mul ?v_0 (bvsub ?v_0 (_ bv1 32)))))

	(= (_ bv1 32)
	   (_lt ?v_1 (bvadd (bvsub ?v_1 ?v_0)
	   	     (_ bv2 32)))))))
