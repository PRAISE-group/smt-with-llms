...
(declare-fun in_natural_bv32 ((_ BitVec 8)) (_ BitVec 8))
(declare-fun get_hword ((_ BitVec 8)) (_ BitVec 8))
(declare-fun get_lword ((_ BitVec 8)) (_ BitVec 8))
(declare-fun bvshl_int ((_ BitVec 8) (_ BitVec 8)) (_ BitVec 8))
(declare-fun bvshr_int ((_ BitVec 8) (_ BitVec 8)) (_ BitVec 8))
(declare-fun bvlshr_int ((_ BitVec 8) (_ BitVec 8)) (_ BitVec 8))
(declare-fun bvuaddo_64 ((_ BitVec 8) (_ BitVec 8)) (_ BitVec 8))
