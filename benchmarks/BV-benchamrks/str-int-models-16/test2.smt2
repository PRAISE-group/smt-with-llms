...
(declare-fun numvowels_str4 ((_ BitVec 16) (_ BitVec 16) (_ BitVec 16) (_ BitVec 16)) (_ BitVec 16))
...
(and  (and  (and  (and
      ...
      (=  true (=  (_ bv2 16)  numvowels_ret ) ) )
      (=  false (=  (_ bv3 16)  numvowels_ret ) ) )
      (=  false (=  (_ bv4 16)  numvowels_ret ) ) ) )
