...
(declare-fun buffer_10 () (_ BitVec 64) )
...
(declare-fun isalpha_ret_10 () (_ BitVec 64) )
...
(assert (= isalpha_ret_9 (isalpha_ buffer_9)))
(assert (= isalpha_ret_10 (isalpha_ buffer_10)))
...
(=  false (=  (_ bv0 64) buffer_10 ) ) 
(=  false (= (_ bv0 64) isalpha_ret_10 ) ) )
