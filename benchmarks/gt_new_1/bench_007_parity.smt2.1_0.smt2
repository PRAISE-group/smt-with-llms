...
(assert
 ...
 (let (($x196 (and (= SIV@32 (my__builtin_parity_cb SIV@31)) (= SIV@33 (ite (= SIV@32 (_ bv1 32)) (_ bv1 1) (_ bv0 1))))))
 ...
 (let (($x250 (and (= SIV@26 (bvxor $u0 (bvsub (_ bv0 32) (_ bv1 32)))) (= SIV@27 (my__builtin_parity_cb SIV@26)))))
 ...
 (let (($x288 (and (boogie_si_record_ref main) (= SIV@24 (my__builtin_parity_cb $u0)))))
