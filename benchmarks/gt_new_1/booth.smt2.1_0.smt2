...
(assert
 ...
 (let (($x263 (and (boogie_si_record_i32 SIV@28) (= SIV@29 (booth_int_cb 3000 3000)))))
 (let (($x257 (and (boogie_si_record_i32 SIV@27) (= SIV@28 (booth_int_cb 2000 1000)))))
 (let (($x272 (=> (and (= SIV@27 (booth_int_cb 0 0)) $x257 (and $x263 $x268) $x248 (and (= SIV@30 1) (= (ControlFlow 1 292186) 292187)) (= (ControlFlow 1 292187) 292188) (= (ControlFlow 1 292188) 292189) $x224 (not (= SIV@31 1)) (and $x208 (and SIV@34 (= (ControlFlow 1 292190) 292191))) (and (not SIV@32) (= (ControlFlow 1 292191) (- 0 317813)))) (not (and (= SIV@4 SIV@35) (= SIV@3 SIV@32))))))
 (let (($x283 (=> (and (and (= SIV@26 1) (= (ControlFlow 1 292182) 292183)) (= (ControlFlow 1 292183) 292184) (= SIV@27 (booth_int_cb 0 0)) $x257 (and $x263 $x268) $x248 (and (= SIV@30 1) (= (ControlFlow 1 292186) 292187)) (= (ControlFlow 1 292187) 292188) (= (ControlFlow 1 292188) 292189) $x224 (not (= SIV@31 1)) (and $x208 (and SIV@34 (= (ControlFlow 1 292190) 292191))) (and (not SIV@32) (= (ControlFlow 1 292191) (- 0 317813)))) (not (and (= SIV@4 SIV@35) (= SIV@3 SIV@32))))))
 (let (($x291 (and (= SIV@26 (ite (>= SIV@23 0) 1 0)) (= (ControlFlow 1 292181) 292182))))
 (let (($x300 (=> (and (= (ControlFlow 1 292179) 292180) (= (ControlFlow 1 292180) 292181) $x291 (and (= SIV@26 1) (= (ControlFlow 1 292182) 292183)) (= (ControlFlow 1 292183) 292184) (= SIV@27 (booth_int_cb 0 0)) $x257 (and $x263 $x268) $x248 (and (= SIV@30 1) (= (ControlFlow 1 292186) 292187)) (= (ControlFlow 1 292187) 292188) (= (ControlFlow 1 292188) 292189) $x224 (not (= SIV@31 1)) (and $x208 (and SIV@34 (= (ControlFlow 1 292190) 292191))) (and (not SIV@32) (= (ControlFlow 1 292191) (- 0 317813)))) (not (and (= SIV@4 SIV@35) (= SIV@3 SIV@32))))))
 (let (($x307 (=> (and (and (= SIV@25 1) (= (ControlFlow 1 292178) 292179)) (= (ControlFlow 1 292179) 292180) (= (ControlFlow 1 292180) 292181) $x291 (and (= SIV@26 1) (= (ControlFlow 1 292182) 292183)) (= (ControlFlow 1 292183) 292184) (= SIV@27 (booth_int_cb 0 0)) $x257 (and $x263 $x268) $x248 (and (= SIV@30 1) (= (ControlFlow 1 292186) 292187)) (= (ControlFlow 1 292187) 292188) (= (ControlFlow 1 292188) 292189) $x224 (not (= SIV@31 1)) (and $x208 (and SIV@34 (= (ControlFlow 1 292190) 292191))) (and (not SIV@32) (= (ControlFlow 1 292191) (- 0 317813)))) (not (and (= SIV@4 SIV@35) (= SIV@3 SIV@32))))))
 ...
 (let (($x321 (and (boogie_si_record_ref main) (= SIV@23 (booth_int_cb 1000 3000)))))
 (let (($x330 (=> (and true (and true SIV@33) (and $x321 $x326) $x314 (and (= SIV@25 1) (= (ControlFlow 1 292178) 292179)) (= (ControlFlow 1 292179) 292180) (= (ControlFlow 1 292180) 292181) $x291 (and (= SIV@26 1) (= (ControlFlow 1 292182) 292183)) (= (ControlFlow 1 292183) 292184) (= SIV@27 (booth_int_cb 0 0)) $x257 (and $x263 $x268) $x248 (and (= SIV@30 1) (= (ControlFlow 1 292186) 292187)) (= (ControlFlow 1 292187) 292188) (= (ControlFlow 1 292188) 292189) $x224 (not (= SIV@31 1)) (and $x208 (and SIV@34 (= (ControlFlow 1 292190) 292191))) (and (not SIV@32) (= (ControlFlow 1 292191) (- 0 317813)))) (not (and (= SIV@4 SIV@35) (= SIV@3 SIV@32))))))
