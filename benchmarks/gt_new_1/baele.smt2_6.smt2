...
(assert
 ...
 (=> SIV_5 $x693))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x850 (and (and true true) (and SIV_51 (= (ControlFlow 2 232540) (- 0 238416))))))
 (let (($x857 (=> (and (= (ControlFlow 2 238381) 232540) true (and true SIV_50) $x850) false)))
 (let (($x863 (and (= (ControlFlow 2 0) 238383) (not (=> (and (and true (= (ControlFlow 2 238383) 238381)) (= (ControlFlow 2 238381) 232540) true (and true SIV_50) $x850) false)))))
 (=> SIV_42 $x863)))))
(assert
 (let (($x875 (not SIV_56)))
 (let (($x876 (= SIV_37 $x875)))
 (let (($x877 (=> (= (ControlFlow 3 238446) (- 0 238531)) $x876)))
 (let (($x902 (=> (and (and (= SIV_56 SIV_55) (= (ControlFlow 3 232183) 238446)) (= (ControlFlow 3 238446) (- 0 238531))) $x876)))
 (let (($x909 (=> (and (and (= SIV_55 SIV_35) (= (ControlFlow 3 232182) 232183)) (and (= SIV_56 SIV_55) (= (ControlFlow 3 232183) 238446)) (= (ControlFlow 3 238446) (- 0 238531))) $x876)))
 (let (($x917 (=> (and (= (ControlFlow 3 232177) 232182) (not (= 0 $0)) (and (= SIV_55 SIV_35) (= (ControlFlow 3 232182) 232183)) (and (= SIV_56 SIV_55) (= (ControlFlow 3 232183) 238446)) (= (ControlFlow 3 238446) (- 0 238531))) $x876)))
 (let (($x884 (=> (and (and (= SIV_56 false) (= (ControlFlow 3 232179) 238446)) (= (ControlFlow 3 238446) (- 0 238531))) $x876)))
 (let (($x894 (and (=> (and (= (ControlFlow 3 232178) 232179) (not false) (and (= SIV_56 false) (= (ControlFlow 3 232179) 238446)) (= (ControlFlow 3 238446) (- 0 238531))) $x876) (=> (= (ControlFlow 3 232178) 232180) true))))
 (let (($x886 (= 0 $0)))
 (let (($x919 (=> (boogie_si_record_i32 0) (and (=> (and (= (ControlFlow 3 232177) 232178) $x886) $x894) $x917))))
 (let (($x927 (=> (and (and SIV_35 (= (ControlFlow 3 238451) 238444)) (= (ControlFlow 3 238444) 232177) (boogie_si_record_i32 0)) (and (=> (and (= (ControlFlow 3 232177) 232178) $x886) $x894) $x917))))
 (=> SIV_47 (and (= (ControlFlow 3 0) 238451) (not $x927)))))))))))))))
(assert
