...
(assert
 ...
 (let (($x535 (and (boogie_si_record_i32 SIV@28) (= SIV@29 (beale_int_cb 2000 2000)))))
 (let (($x542 (=> (and (and $x535 $x540) (= SIV@30 (ite (> SIV@28 0) 1 0))) $x526)))
 (let (($x547 (=> (and (= (ControlFlow 1 231984) 231989) (= SIV@28 (beale_int_cb 1000 1000)) (and $x535 $x540) (= SIV@30 (ite (> SIV@28 0) 1 0))) $x526)))
 (let (($x554 (=> (and (and (= SIV@27 SIV@26) (= (ControlFlow 1 231988) 231984)) (= (ControlFlow 1 231984) 231989) (= SIV@28 (beale_int_cb 1000 1000)) (and $x535 $x540) (= SIV@30 (ite (> SIV@28 0) 1 0))) $x526)))
 (let (($x589 (=> (and (= (ControlFlow 1 231985) 231987) (and SIV@26 (= (ControlFlow 1 231987) 231988)) (and (= SIV@27 SIV@26) (= (ControlFlow 1 231988) 231984)) (= (ControlFlow 1 231984) 231989) (= SIV@28 (beale_int_cb 1000 1000)) (and $x535 $x540) (= SIV@30 (ite (> SIV@28 0) 1 0))) $x526)))
 ...
 (let (($x568 (=> (and (and (= SIV@27 SIV@24) (= (ControlFlow 1 231983) 231984)) (= (ControlFlow 1 231984) 231989) (= SIV@28 (beale_int_cb 1000 1000)) (and $x535 $x540) (= SIV@30 (ite (> SIV@28 0) 1 0))) $x526)))
 (let (($x561 (= SIV@25 1)))
 (let (($x603 (and (=> (and (= (ControlFlow 1 231982) 231983) $x561 (and (= SIV@27 SIV@24) (= (ControlFlow 1 231983) 231984)) (= (ControlFlow 1 231984) 231989) (= SIV@28 (beale_int_cb 1000 1000)) (and $x535 $x540) (= SIV@30 (ite (> SIV@28 0) 1 0))) $x526) (=> (and (= (ControlFlow 1 231982) 231985) (and (and (not $x561) SIV@24) (and true SIV@44))) (and (=> (and (= (ControlFlow 1 231985) 231986) $x577 (= (ControlFlow 1 237427) (- 0 238249))) $x327) $x589)))))
 ...
 (let (($x674 (and (boogie_si_record_ref main) (= SIV@20 (beale_int_cb 3000 500)))))
 ...
 (=> SIV@5 $x693))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let (($x850 (and (and true true) (and SIV@51 (= (ControlFlow 2 232540) (- 0 238416))))))
 (let (($x857 (=> (and (= (ControlFlow 2 238381) 232540) true (and true SIV@50) $x850) false)))
 (let (($x863 (and (= (ControlFlow 2 0) 238383) (not (=> (and (and true (= (ControlFlow 2 238383) 238381)) (= (ControlFlow 2 238381) 232540) true (and true SIV@50) $x850) false)))))
 (=> SIV@42 $x863)))))
(assert
 (let (($x875 (not SIV@56)))
 (let (($x876 (= SIV@37 $x875)))
 (let (($x877 (=> (= (ControlFlow 3 238446) (- 0 238531)) $x876)))
 (let (($x902 (=> (and (and (= SIV@56 SIV@55) (= (ControlFlow 3 232183) 238446)) (= (ControlFlow 3 238446) (- 0 238531))) $x876)))
 (let (($x909 (=> (and (and (= SIV@55 SIV@35) (= (ControlFlow 3 232182) 232183)) (and (= SIV@56 SIV@55) (= (ControlFlow 3 232183) 238446)) (= (ControlFlow 3 238446) (- 0 238531))) $x876)))
 (let (($x917 (=> (and (= (ControlFlow 3 232177) 232182) (not (= 0 $0)) (and (= SIV@55 SIV@35) (= (ControlFlow 3 232182) 232183)) (and (= SIV@56 SIV@55) (= (ControlFlow 3 232183) 238446)) (= (ControlFlow 3 238446) (- 0 238531))) $x876)))
 (let (($x884 (=> (and (and (= SIV@56 false) (= (ControlFlow 3 232179) 238446)) (= (ControlFlow 3 238446) (- 0 238531))) $x876)))
 (let (($x894 (and (=> (and (= (ControlFlow 3 232178) 232179) (not false) (and (= SIV@56 false) (= (ControlFlow 3 232179) 238446)) (= (ControlFlow 3 238446) (- 0 238531))) $x876) (=> (= (ControlFlow 3 232178) 232180) true))))
 (let (($x886 (= 0 $0)))
 (let (($x919 (=> (boogie_si_record_i32 0) (and (=> (and (= (ControlFlow 3 232177) 232178) $x886) $x894) $x917))))
 (let (($x927 (=> (and (and SIV@35 (= (ControlFlow 3 238451) 238444)) (= (ControlFlow 3 238444) 232177) (boogie_si_record_i32 0)) (and (=> (and (= (ControlFlow 3 232177) 232178) $x886) $x894) $x917))))
 (=> SIV@47 (and (= (ControlFlow 3 0) 238451) (not $x927)))))))))))))))
(assert
 (let (($x982 (=> (and (= (ControlFlow 4 238551) 232505) (= (ControlFlow 4 232505) (- 0 238558))) false)))
 (let (($x988 (and (= (ControlFlow 4 0) 238553) (not (=> (and (and true (= (ControlFlow 4 238553) 238551)) (= (ControlFlow 4 238551) 232505) (= (ControlFlow 4 232505) (- 0 238558))) false)))))
 (=> SIV@50 $x988))))
(assert
 (let (($x1003 (=> (and (= (ControlFlow 5 238566) 232469) (= (ControlFlow 5 232469) (- 0 238585))) false)))
 (let (($x1009 (and (= (ControlFlow 5 0) 238568) (not (=> (and (and true (= (ControlFlow 5 238568) 238566)) (= (ControlFlow 5 238566) 232469) (= (ControlFlow 5 232469) (- 0 238585))) false)))))
 (=> SIV@51 $x1009))))
(assert
 (not SIV@43))
(assert
