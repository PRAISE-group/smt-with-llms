...
(assert
 (let (($x813 (and (and true true) (and SIV_45 (= (ControlFlow 2 232301) (- 0 238065))))))
 (let (($x820 (=> (and (= (ControlFlow 2 238030) 232301) true (and true SIV_44) $x813) false)))
 (let (($x826 (and (= (ControlFlow 2 0) 238032) (not (=> (and (and true (= (ControlFlow 2 238032) 238030)) (= (ControlFlow 2 238030) 232301) true (and true SIV_44) $x813) false)))))
 (=> SIV_37 $x826)))))
(assert
 (let (($x837 (not SIV_50)))
 (let (($x838 (= SIV_30 $x837)))
 (let (($x839 (=> (= (ControlFlow 3 238095) (- 0 238180)) $x838)))
 (let (($x864 (=> (and (and (= SIV_50 SIV_49) (= (ControlFlow 3 231944) 238095)) (= (ControlFlow 3 238095) (- 0 238180))) $x838)))
 (let (($x871 (=> (and (and (= SIV_49 SIV_25) (= (ControlFlow 3 231943) 231944)) (and (= SIV_50 SIV_49) (= (ControlFlow 3 231944) 238095)) (= (ControlFlow 3 238095) (- 0 238180))) $x838)))
 (let (($x879 (=> (and (= (ControlFlow 3 231938) 231943) (not (= 0 $0)) (and (= SIV_49 SIV_25) (= (ControlFlow 3 231943) 231944)) (and (= SIV_50 SIV_49) (= (ControlFlow 3 231944) 238095)) (= (ControlFlow 3 238095) (- 0 238180))) $x838)))
 (let (($x846 (=> (and (and (= SIV_50 false) (= (ControlFlow 3 231940) 238095)) (= (ControlFlow 3 238095) (- 0 238180))) $x838)))
 (let (($x856 (and (=> (and (= (ControlFlow 3 231939) 231940) (not false) (and (= SIV_50 false) (= (ControlFlow 3 231940) 238095)) (= (ControlFlow 3 238095) (- 0 238180))) $x838) (=> (= (ControlFlow 3 231939) 231941) true))))
 (let (($x848 (= 0 $0)))
 (let (($x881 (=> (boogie_si_record_i32 0) (and (=> (and (= (ControlFlow 3 231938) 231939) $x848) $x856) $x879))))
 (let (($x889 (=> (and (and SIV_25 (= (ControlFlow 3 238100) 238093)) (= (ControlFlow 3 238093) 231938) (boogie_si_record_i32 0)) (and (=> (and (= (ControlFlow 3 231938) 231939) $x848) $x856) $x879))))
 (=> SIV_40 (and (= (ControlFlow 3 0) 238100) (not $x889)))))))))))))))
(assert
 (let (($x945 (=> (and (= (ControlFlow 4 238200) 232266) (= (ControlFlow 4 232266) (- 0 238207))) false)))
 (let (($x951 (and (= (ControlFlow 4 0) 238202) (not (=> (and (and true (= (ControlFlow 4 238202) 238200)) (= (ControlFlow 4 238200) 232266) (= (ControlFlow 4 232266) (- 0 238207))) false)))))
 (=> SIV_44 $x951))))
(assert
 (let (($x965 (=> (and (= (ControlFlow 5 238215) 232230) (= (ControlFlow 5 232230) (- 0 238234))) false)))
 (let (($x971 (and (= (ControlFlow 5 0) 238217) (not (=> (and (and true (= (ControlFlow 5 238217) 238215)) (= (ControlFlow 5 238215) 232230) (= (ControlFlow 5 232230) (- 0 238234))) false)))))
 (=> SIV_45 $x971))))
(assert
 (not SIV_38))
(assert
