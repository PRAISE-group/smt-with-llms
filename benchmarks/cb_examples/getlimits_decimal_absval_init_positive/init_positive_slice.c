...
static void init_positive_impl(char *buf, uint16_t num_digits, uint16_t digit0,
...
typedef struct InitPositiveResult {
  uint16_t byte0;
  uint16_t byte1;
  uint16_t byte2;
  uint16_t byte3;
...
InitPositiveResult init_positive_cb(uint16_t num_digits, uint16_t digit0,
                                    uint16_t digit1, uint16_t digit2,
                                    uint16_t digit3, uint16_t digit4,
                                    uint16_t digit5, uint16_t digit6,
  ...
  InitPositiveResult out;

  load_buf(buf, in0, in1, in2, in3, in4, in5, in6, in7, in8, in9);
  init_positive_impl(buf, num_digits, digit0, digit1, digit2, digit3, digit4,
                     digit5, digit6);
