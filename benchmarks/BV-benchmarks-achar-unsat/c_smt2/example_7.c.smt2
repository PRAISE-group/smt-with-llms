...
( define-fun pre-f ( ( bit Int )( num Int )( num_orig Int )( res Int )( bit_0 Int )( bit_1 Int )( bit_2 Int )( bit_3 Int )( bit_4 Int )( bit_5 Int )( num_0 Int )( num_orig_0 Int )( num_orig_1 Int )( res_0 Int )( res_1 Int )( res_2 Int )( res_3 Int )( res_4 Int )( res_5 Int ) ) Bool
	( and
		( = bit bit_1 )
		( = num num_0 )
		( = num_orig num_orig_1 )
...
( define-fun trans-f ( ( bit Int )( num Int )( num_orig Int )( res Int )( bit! Int )( num! Int )( num_orig! Int )( res! Int )( bit_0 Int )( bit_1 Int )( bit_2 Int )( bit_3 Int )( bit_4 Int )( bit_5 Int )( num_0 Int )( num_orig_0 Int )( num_orig_1 Int )( res_0 Int )( res_1 Int )( res_2 Int )( res_3 Int )( res_4 Int )( res_5 Int ) ) Bool
	( or
		( and
			( = bit_2 bit )
			( = bit_2 bit! )
...
( define-fun post-f ( ( bit Int )( num Int )( num_orig Int )( res Int )( bit_0 Int )( bit_1 Int )( bit_2 Int )( bit_3 Int )( bit_4 Int )( bit_5 Int )( num_0 Int )( num_orig_0 Int )( num_orig_1 Int )( res_0 Int )( res_1 Int )( res_2 Int )( res_3 Int )( res_4 Int )( res_5 Int ) ) Bool
	( or
		( not
			( and
				( = bit bit_2)
